...
function Footer(): JSX.Element {
    return (
        <footer className="border-t-3 border-dark-highlight">
            <div className="container mx-auto flex justify-between items-center py-3 px-6 text-text gap-3">
                ...
                <div onClick={() => window.location.href = "https://enem.dev/"} className="group flex gap-3 items-center hover:cursor-pointer hover:text-text-hover flex-shrink-0">
